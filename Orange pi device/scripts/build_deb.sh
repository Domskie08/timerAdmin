...
BUILD_DIR="$(mktemp -d "${TMPDIR:-/tmp}/${PACKAGE_NAME}.deb.XXXXXX")"
...
cp packaging/dtimer-orange-pi-customer-lan.service "${PKG_DIR}/etc/systemd/system/dtimer-orange-pi-customer-lan.service"
...
chmod 0755 "${PKG_DIR}/opt/dtimer-orange-pi/scripts/configure_usb_customer_lan.sh"
chmod 0644 "${PKG_DIR}/etc/dtimer-orange-pi/dtimer.conf"
chmod 0644 "${PKG_DIR}/etc/systemd/system/dtimer-orange-pi.service"
chmod 0644 "${PKG_DIR}/etc/systemd/system/dtimer-orange-pi-customer-lan.service"
